...
data_ip="https://raw.githubusercontent.com/JP OFFICIALWebId/izinsc/main/ip"
checking_sc() {
...
url_izin="https://raw.githubusercontent.com/JP OFFICIALWebId/izinsc/main/ip"
rm -f /usr/bin/user
...
EXPSC=$(wget -qO- $url_izin | grep $ipsaya | awk '{print $2}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/JP OFFICIALSTORE"},{"text":"Contack","url":"wa.me/+wa.me/087873951705"}]]}'
